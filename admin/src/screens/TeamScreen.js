...
import { listTeam, deleteTeam } from "../actions/teamActions";
      ...
      <div>
        ...
        <div className="max-w-4xl mx-auto px-8 bg-white shadow py-16">
          ...
          <div className="grid gap-10 mx-auto lg:grid-cols-2 mt-5 lg:max-w-screen-lg">
            {teams &&
              teams.map((team) => (
                <div key={team._id} className="grid sm:grid-cols-3">
                  ...
                  <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
                    ...
                    <div
                      dangerouslySetInnerHTML={createMarkup(team.description)}
                    ></div>
