       ...
       >
        <div className="h-screen p-0">
          <div className="relative">
            <img src="bg1.jpg" className="relative object-cover  h-full w-full"/>
            <div className="bg-gray-900  bg-opacity-30 absolute inset-0"></div>
          </div>
            <div className="absolute top-48 left-56 max-w-xl">
            <ScrollAnimation
        ...
        <div className="h-screen p-0">
          <div className="relative">
            <img src="bg2.jpg" className="relative object-cover  h-full w-full"/>
            <div className="bg-gray-900  bg-opacity-30 absolute inset-0"></div>
          </div>
        ...
        <div className="h-screen p-0">
          <div className="relative">
            <img src="bg3.jpg" className="relative object-cover  h-full w-full"/>
            <div className="bg-gray-900  bg-opacity-30 absolute inset-0"></div>
          </div>
            <div className="absolute top-72 left-56 max-w-xl">
              <h1 className="text-white opacity-100 text-4xl capitalize font-semibold">
